...
*Load with:*
```
{:blurSize 0, :class origami.filters.brandnew.DiffusingLightWithROI, :contrastFix 75}
```
*Result:*

![](brandnew.diffusinglightwithroi.png)
...
*Load with:*
```
{:class origami.filters.detect.EastTextDetector}
```
*Result:*
...
*Load with:*
```
{:chosenGlyphOffset 0.0, :chosenGlyphPosition nil, :class origami.filters.doge.GlyphDetector, :foundRect true, :frameSize #object[org.opencv.core.Size 0x353f472a "307x231"]}
```
*Result:*
...
![](video.sub.scanlines.simple.png)
